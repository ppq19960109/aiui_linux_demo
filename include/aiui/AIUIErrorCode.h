...
#undef ERROR_INVALID_DATA
	...
	static const int ERROR_IVW_AUTH_DENY       = 25201; /** 语音唤醒授权拒绝 */
	static const int ERROR_IVW_AUTH_NOT_CHECK  = 25202; /** 语音唤醒授权未检查 */
	static const int ERROR_IVW_AUTH_INV_ARG    = 25203; /** 语音唤醒授权无效参数 */
	static const int ERROR_IVW_AUTH_BUSY       = 25204; /** 语音唤醒授权繁忙 */
	static const int ERROR_IVW_AUTH_ERR        = 25205; /** 语音唤醒授权错误 */


	static const int ERROR_ESR_IAT_AUTH_DENY       = 25301; /** 离线听写授权拒绝 */
	static const int ERROR_ESR_IAT_AUTH_NOT_CHECK  = 25302; /** 离线听写授权未检查 */
	static const int ERROR_ESR_IAT_AUTH_INV_ARG    = 25303; /** 离线听写授权无效参数 */
	static const int ERROR_ESR_IAT_AUTH_BUSY       = 25304; /** 离线听写授权繁忙 */
	static const int ERROR_ESR_IAT_AUTH_ERR        = 25305; /** 离线听写授权错误 */


	static const int ERROR_ESR_ASR_AUTH_DENY       = 25401; /** 离线命令词识别授权拒绝 */
	static const int ERROR_ESR_ASR_AUTH_NOT_CHECK  = 25402; /** 离线命令词识别授权未检查 */
	static const int ERROR_ESR_ASR_AUTH_INV_ARG    = 25403; /** 离线命令词识别授权无效参数 */
	static const int ERROR_ESR_ASR_AUTH_BUSY       = 25404; /** 离线命令词识别授权繁忙 */
	static const int ERROR_ESR_ASR_AUTH_ERR        = 25405; /** 离线命令词识别授权错误 */

	static const int ERROR_AVVAD_AUTH_DENY       = 25501; /** 多模态VAD授权拒绝 */
	static const int ERROR_AVVAD_AUTH_NOT_CHECK  = 25502; /** 多模态VAD授权未检查 */
	static const int ERROR_AVVAD_AUTH_INV_ARG    = 25503; /** 多模态VAD授权无效参数 */
	static const int ERROR_AVVAD_AUTH_BUSY       = 25504; /** 多模态VAD授权繁忙 */
	static const int ERROR_AVVAD_AUTH_ERR        = 25505; /** 多模态VAD授权错误 */
};
