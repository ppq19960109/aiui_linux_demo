...
public:
    ...
    * arg1 表示加载的语法ID
    **/
    static const int CMD_LOAD_GRAMMAR = 28;

    /**
    * 卸载语法
    * arg1 b表示卸载的语法ID
    **/
    static const int CMD_UNLOAD_GRAMMAR = 29;

    static const int CMD_QUERY_LOC = 30;
    /**
     * "play_mode":"control", 控制tts开始播放
     */
    static const int CMD_TTS_PLAY_RESUME = 31;
    /**
    * CAE鉴权，写入设备信息。
    */
