...
public:
	 ...
	 **/
    const char* getBinary(const char* key, int* dataLen) const;
};
...
public:
	 ...
	 */
    const IDataBundle* getData() const;
};
...
public:
	 ...
	 */
    static IAIUIAgent* createAgent(const char* params, IAIUIListener* listener);
	 ...
	 */
    void sendMessage(const IAIUIMessage* message);
...
public:
	 ...
	 * @return 是否设置成功
	 */
    static bool setAIUIDir(const char* szDir);
	 ...
	 * @return 是否设置成功
	 */
    static bool setMscDir(const char* szDir);
	 ...
	 * @return 是否设置成功
	 */
    static bool setMscCfg(const char* szCfg);
	 ...
	 * @return 是否成功
	 */
    static bool initLogger(const char* szLogDir = "");
	 ...
	 * @param level 日志等级，具体取值参考LogLevel定义
	 */
    static void setNetLogLevel(LogLevel level);
	 ...
	 */
    static void setSaveDataLog(bool save, int logSizeMB = -1);
	 ...
	 * @return 是否设置成功
	 */
    static bool setDataLogDir(const char* szDir);
	 ...
	 * @param dir 目录（windows下以"\\"结尾，其他平台以"/"结尾）
	 */
    static bool setRawAudioDir(const char* dir);
	 ...
	 */
    static VersionType getVersionType();
	 ...
	 * @param val
	 */
    static void setSystemInfo(const char* key, const char* val);
     ...
     *
     */
    static int getSystemInfo(const char* key, char* out, int max_size);
};
...
IAIUIMessage* IAIUIMessage::create(
...
void IAIUIMessage::destroy()
{
    aiui_msg_destroy(am);
    delete this;
}

void IAIUIAgent::sendMessage(const IAIUIMessage* message)
{
    aiui_agent_send_message(ag, message->am);
}

IAIUIAgent* IAIUIAgent::createAgent(const char* params, IAIUIListener* listener)
{
...
void IAIUIAgent::destroy()
{
    aiui_agent_destroy(ag);
    delete this;
}

const char* IDataBundle::getString(const char* key, const char* defaultVal) const
{
    return aiui_db_string(ab, key, defaultVal);
}

const char* IDataBundle::getBinary(const char* key, int* dataLen) const
{
    return aiui_db_binary(ab, key, dataLen);
}

const IDataBundle* IAIUIEvent::getData() const
{
    return (const IDataBundle*)&db;
}

int IAIUIEvent::getEventType() const
{
    return aiui_event_type(ae);
}

int IAIUIEvent::getArg1() const
{
    return aiui_event_arg1(ae);
}

int IAIUIEvent::getArg2() const
{
    return aiui_event_arg2(ae);
}

const char* IAIUIEvent::getInfo() const
{
    return aiui_event_info(ae);
}

bool AIUISetting::setAIUIDir(const char* szDir)
{
    return aiui_set_aiui_dir(szDir);
}

VersionType AIUISetting::getVersionType()
{
    return aiui_get_version_type();
}

bool AIUISetting::isMobileVersion()
{
    return aiui_is_mobile_version();
}

bool AIUISetting::setRawAudioDir(const char* dir)
{
    return aiui_set_raw_audio_dir(dir);
}
bool AIUISetting::setDataLogDir(const char* szDir)
{
    return aiui_set_data_log_dir(szDir);
}

void AIUISetting::setSaveDataLog(bool save, int logSizeMB)
{
    aiui_set_save_data_log(save, logSizeMB);
}

void AIUISetting::setNetLogLevel(LogLevel level)
{
    aiui_set_net_log_level(level);
}

void AIUISetting::setLogLevel(LogLevel level)
{
    aiui_set_log_level(level);
}

bool AIUISetting::initLogger(const char* szLogDir)
{
    return aiui_init_logger(szLogDir);
}

bool AIUISetting::setMscCfg(const char* szCfg)
{
    return aiui_set_msc_cfg(szCfg);
}

bool AIUISetting::setMscDir(const char* szDir)
{
    return aiui_set_msc_dir(szDir);
}

void AIUISetting::setSystemInfo(const char* key, const char* val)
{
    aiui_set_system_info(key, val);
}

int AIUISetting::getSystemInfo(const char* key, char* out, int max_size)
{
